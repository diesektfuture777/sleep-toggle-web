...
rm -rf dist
mkdir -p dist/icons
cp index.html app.js lib.js liquid.js sleep-aid.js style.css manifest.json sw.js dist/
...
HASH=$(cat dist/index.html dist/app.js dist/lib.js dist/liquid.js dist/sleep-aid.js dist/style.css \
